	...
	public void GenerateMap()
	{
		...
		switch (mapSetting.algorithm)
		{
			...
			case Algorithm.PerlinCave:
				...
				map = MapFunctions.GenerateArray(width, height, true);
				//Next generate the perlin noise onto the array
				map = MapFunctions.PerlinNoiseCave(map, Random.Range(0.15f, 0.2f), mapSetting.edgesAreWalls);
				break;
		...
		//Render the result
		MapFunctions.RenderMapWithOffset(map, tilemap, tile, new Vector2Int(-20, -20));
	}
